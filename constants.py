...
SURVEY_LINE_LENGTH_COMPLETE = 12
SURVEY_LINE_ANSWER_Q1 = 14
SURVEY_LINE_FIRST_NAME = 26
SURVEY_LINE_LAST_NAME = 27
SURVEY_NO_QUESTION_NB_WORK_HOURS = 6
SURVEY_NUMERICAL_QUESTIONS_INDEX = (7,)

# Constants related to results files
RESULTS_TOKENS_GROUP_PROJECTS = ('TP', 'TRAVAIL', 'PRATIQUE', 'DEV')
RESULTS_TOKENS_MIDTERMS = ('INTRA', 'EXAM')
RESULTS_TOKENS_FINAL_EXAM = ('FINAL',)
RESULTS_TEAM_FLAG = 'Équ.'
RESULTS_IDX_CORRECTED_ON = 'Corrected on'
RESULTS_IDX_WEIGHT = 'Weight'
RESULTS_IDX_GROUP_PROJECT = 'Group project'
RESULTS_COL_IDX_GRADE = -1
